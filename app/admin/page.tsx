  ...
  return (
    <main className="admin-dashboard">
      ...
      <div className="admin-shell admin-content">
        <div className="admin-welcome"><div><p>歡迎回來，{profile.display_name || "管理員"}</p><h1>活動管理總覽</h1></div><div className="admin-welcome-actions"><Link className="button button-secondary button-large" href="/admin/telegram"><Bot />Telegram 通知</Link><Link className="button button-secondary button-large" href="/admin/site-settings"><ImageIcon />首頁橫額設定</Link><Link className="button button-primary button-large" href="/admin/events/new"><CalendarPlus />建立新活動</Link></div></div>
